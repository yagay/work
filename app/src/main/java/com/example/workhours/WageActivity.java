...
public class WageActivity extends Activity {
    ...
    private ScrollView buildUi() {
        ...
        hourlyMode = new RadioButton(this);
        hourlyMode.setText("按小时工资");
        monthlyMode = new RadioButton(this);
    ...
    private void saveWageSettings() {
        ...
        prefs.edit()
                ...
                .apply();
        Toast.makeText(this, "工资设置已保存", Toast.LENGTH_SHORT).show();
        refreshAll();
    }
    ...
    private void saveDeduction() {
        ...
        e.apply();
        Toast.makeText(this, "扣工资设置已保存", Toast.LENGTH_SHORT).show();
        refreshAll();
    }
    ...
    private void applySafeInsets(View root) {
        root.setOnApplyWindowInsetsListener((v, insets) -> {
            int top = insets.getInsets(WindowInsets.Type.systemBars() | WindowInsets.Type.displayCutout()).top;
