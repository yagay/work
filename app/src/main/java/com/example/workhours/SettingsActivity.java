...
public class SettingsActivity extends Activity {
    ...
    private ScrollView buildUi() {
        ...
        TextView holidayInfo = text("公共假日会自动从正常工时和上班闹钟中排除；是否计算一天工资可在下方设置。请假和休息可直接在主页月历中编辑，长按日期可多选批量修改。", UI_BODY_SP, false);
    ...
    private boolean isPublicHolidayPaidSetting() {
    ...
    private void loadSettings() {
        ...
        if (publicHolidayPaidCheck != null) publicHolidayPaidCheck.setChecked(isPublicHolidayPaidSetting());
